...
var DatabaseAdapterCompat = exports.default = /*#__PURE__*/function () {
  ...
  _proto.provideSyncJson = function (id, syncPullResultJson) {
    var _this0 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this0.underlyingAdapter.provideSyncJson(id, syncPullResultJson, callback);
    });
  };
  _proto.unsafeResetDatabase = function () {
    var _this1 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this1.underlyingAdapter.unsafeResetDatabase(callback);
    });
  };
  _proto.unsafeExecute = function (work) {
    var _this10 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this10.underlyingAdapter.unsafeExecute(work, callback);
    });
  };
  _proto.getLocal = function (key) {
    var _this11 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this11.underlyingAdapter.getLocal(key, callback);
    });
  };
  _proto.setLocal = function (key, value) {
    var _this12 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this12.underlyingAdapter.setLocal(key, value, callback);
    });
  };
  _proto.removeLocal = function (key) {
    var _this13 = this;
    return (0, _Result.toPromise)(function (callback) {
      return _this13.underlyingAdapter.removeLocal(key, callback);
    });
  }
